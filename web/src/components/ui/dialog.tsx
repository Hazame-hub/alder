...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn("fixed inset-0 z-50 bg-bark-950/45 backdrop-blur-[2px]", className)}
    {...props}
  />
));
...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    /** Wide is for the LDIF preview, which is unreadable in a narrow modal. */
    wide?: boolean;
  }
  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogPrimitive.Close
        className="absolute right-3 top-3 rounded-md p-1 text-muted-foreground opacity-70 transition hover:bg-accent hover:opacity-100"
        aria-label="Close"
      >
        <X className="size-4" />
      </DialogPrimitive.Close>
