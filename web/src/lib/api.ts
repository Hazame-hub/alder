...
export type MonitorAccess = Schemas["MonitorAccess"];
export type SearchResultEntry = Schemas["SearchResultEntry"];
export type ObjectViewList = Schemas["ObjectViewList"];
export type ObjectView = Schemas["ObjectView"];
export type ObjectViewId = Schemas["ObjectView"]["id"];
export type ObjectViewColumn = Schemas["ObjectViewColumn"];
export type ReferenceList = Schemas["ReferenceList"];
export type Reference = Schemas["Reference"];
export type MemberList = Schemas["MemberList"];
export type EntryComparison = Schemas["EntryComparison"];
export type AttributeComparison = Schemas["AttributeComparison"];
export type ExpandedMember = Schemas["ExpandedMember"];
...
export type ObjectClassInput = Schemas["ObjectClassInput"];
export type AttributeTypeInput = Schemas["AttributeTypeInput"];
